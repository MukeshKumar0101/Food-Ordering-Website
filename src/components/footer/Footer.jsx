...
function Footer() {
  return (
    <footer className="bg-[#f3632f]  dark:bg-gray-900">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 flex items-center">
            <a href="https://flowbite.com/" className="flex items-center gap-3">
              <img src={foodlogo} alt="FoodLogo" className="w-20" />
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-base font-bold text-white uppercase dark:text-white">
                Resources
              </h2>
